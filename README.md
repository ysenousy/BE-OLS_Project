...
3. Computing quality and relevance metrics for both metadata and paper search outputs.
...
- `step3_search_web.py` and `step4_consolidate.py` are planned in `plan.md` but are not currently present in this workspace.
